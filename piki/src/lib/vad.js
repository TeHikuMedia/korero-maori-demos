...
export default class VAD {
  ...
  constructor(options) {
    ...
    this.options = {
      ...
      energy_offset: 1e-8,//1e-8, // The initial offset.
      energy_threshold_ratio_pos: 16, // Signal must be twice the offset
      energy_threshold_ratio_neg: .25,//0.25, // Signal must be half the offset
      energy_integration: 1, // Size of integration change compared to the signal per second.
      filter: [
        {f: 200, v:0}, // 0 -> 200 is 0
        {f: 8000, v:1} // 200 -> 2k is 1
      ],
      source: null,
      context: null,
      debug: true,
